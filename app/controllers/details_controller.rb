class DetailsController < ApplicationController
  ...
  def update
    respond_to do |format|
      if @detail.update(detail_params)
        format.html { redirect_to @detail, notice: "Detail was successfully updated.", status: :see_other }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to details_path, notice: "Detail was successfully destroyed.", status: :see_other }
  ...
  def correct_user
    ...
    redirect_to details_path, notice: "Not Authorized" if @detail.nil?
  end
end