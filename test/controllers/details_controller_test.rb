...
class DetailsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create detail" do
    assert_difference("Detail.count") do
      post details_url, params: { detail: { contact: @detail.contact, email: @detail.email, first_name: @detail.first_name, last_name: @detail.last_name, twitter: @detail.twitter } }
    end
  ...
  test "should update detail" do
    patch detail_url(@detail), params: { detail: { contact: @detail.contact, email: @detail.email, first_name: @detail.first_name, last_name: @detail.last_name, twitter: @detail.twitter } }
